...
2. Каждая тема = **теория → микро-задание → основная практика → чеклист**
3. Не переходи дальше, пока **все пункты чеклиста** не закрыты
4. На одну тему закладывай **3–5 дней** (у тебя много новых тем параллельно)
5. **Одна папка на всё:** `python-oop-journey/` — не плоди новые проекты
6. Когда застрял больше 40 минут — **стоп**, напиши мне или загугли термин из таблицы
7. **Правило 25 минут:** учишься 25 мин → 5 мин перерыв (Pomodoro). Так проще не бросить
